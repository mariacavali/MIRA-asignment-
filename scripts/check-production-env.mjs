...
const CATEGORIES = [
  ...
  },
  {
    ...
    blocking: false,
    vars: ["MIRA_V3_ENABLED", "MIRA_V3_BIRTH_DATA_ENABLED", "MIRA_PILOT_QA_RETENTION_DAYS", "DAKIDARTS_API_KEY", "DAKIDARTS_API_BASE_URL", "NOTION_INTELLIGENCE_ENABLED", "NOTION_API_KEY", "NOTION_DATABASE_ID", "BUILT_IN_FORGE_API_URL", "BUILT_IN_FORGE_API_KEY", "MIRA_ALLOW_LOCAL_STORAGE_IN_PRODUCTION", "VITE_FRONTEND_FORGE_API_URL", "VITE_FRONTEND_FORGE_API_KEY", "PORT", "VITE_APP_TITLE", "VITE_APP_LOGO", "OWNER_OPEN_ID"],
  },
  {
