...
ALTER TABLE `mira_v3_render_artifacts` ADD CONSTRAINT `mira_render_artifacts_reflection_revision_fk` FOREIGN KEY (`reflectionRevisionId`) REFERENCES `mira_v3_reflection_revisions`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
